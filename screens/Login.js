...
export default () => {
    ...
    return(
        <View style={styles.container}>
            <Text style={styles.header}>Smart List</Text>
            <View style={{flex: 1}}>
                <LabeledInput autoCompleteType="email" label="Email" text={emailField.text} onChangeText={(text)=>{setEmailField({text})}} errorMessage={emailField.errorMessage} labelStyle={styles.label} />
                <LabeledInput secureTextEntry={true} autoCompleteType="password" label="Password" text={passwordField.text} onChangeText={(text)=>{setPasswordField({text})}} errorMessage={passwordField.errorMessage} labelStyle={styles.label} />
                {isCreateMode && (
                <LabeledInput 
